...
data.num_workers = 8
data.training_dataset_path = "/nobackup/zhanpeng/arxiv/train"
data.validation_dataset_path = "/nobackup/zhanpeng/arxiv/validation"
data.tokenizer = "t5-base"
data.collator = "src.t5.data.downstream.summarization.ArxivCollator"
