...
data.num_workers = 8
data.training_dataset_path = "/nobackup/zhanpeng/scrolls-quality/train"
data.validation_dataset_path = "/nobackup/zhanpeng/scrolls-quality/validation"
data.tokenizer = "t5-base"
data.collator = "src.t5.data.downstream.scrolls.QualityCollator"
data.collator_args = Args()
data.collator_args.max_encoder_length = 16384
data.collator_args.max_decoder_length = 90
