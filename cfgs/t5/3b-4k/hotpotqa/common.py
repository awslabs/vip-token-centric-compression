...
data.num_workers = 8
data.training_dataset_path = "/nobackup/zhanpeng/hotpot_qa-distractor/train"
data.validation_dataset_path = "/nobackup/zhanpeng/hotpot_qa-distractor/validation"
data.tokenizer = "t5-base"
data.collator = "src.t5.data.downstream.hotpotqa.HotpotQACollator"
data.collator_args = Args()
data.collator_args.max_encoder_length = 4096
data.collator_args.max_decoder_length = 40
