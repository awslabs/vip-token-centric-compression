...
data.num_workers = 8
data.training_dataset_path = "/nobackup/zhanpeng/scrolls-gov_report/train"
data.validation_dataset_path = "/nobackup/zhanpeng/scrolls-gov_report/validation"
data.tokenizer = "t5-base"
data.collator = "src.t5.data.downstream.scrolls.GovReportCollator"
