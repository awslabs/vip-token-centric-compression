...
data.training_dataset_path = "/nobackup/zhanpeng/mediasum/train"
data.validation_dataset_path = "/nobackup/zhanpeng/mediasum/validation"
data.collator = "src.t5.data.downstream.summarization.MediaSumCollator"
