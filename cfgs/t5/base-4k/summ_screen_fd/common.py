...
data.num_workers = 8
data.training_dataset_path = "/nobackup/zhanpeng/scrolls-summ_screen_fd/train"
data.validation_dataset_path = "/nobackup/zhanpeng/scrolls-summ_screen_fd/validation"
data.tokenizer = "t5-base"
data.collator = "src.t5.data.downstream.scrolls.SummScreenFDCollator"
